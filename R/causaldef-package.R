...
#' @importFrom stats binomial coef confint glm lm na.omit plogis pnorm predict 
#'   qnorm quantile rbinom rnorm sd var weighted.mean as.formula
...
utils::globalVariables(c("covariate", "alpha", "gamma", "delta"))
