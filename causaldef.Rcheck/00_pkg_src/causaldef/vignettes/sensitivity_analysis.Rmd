...
| **Le Cam Deficiency (δ)** | Information loss | "Decision error bounded by 2Mδ" |
...
> the worst-case decision error is bounded by 2Mδ."
...
| **Decision utility** | Abstract | Direct (via 2Mδ bound) |
...
│    → Safety floor = 2Mδ (worst-case regret)                     │
└─────────────────────────────────────────────────────────────────┘
```
