...
- **Computable deficiency proxies**: `estimate_deficiency()` currently returns a PS-TV proxy, not a generic nonparametric estimator of the exact Le Cam deficiency
